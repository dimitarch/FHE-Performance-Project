...
int main() {
    ...
    ad.open("testAND_ALL_random.txt", fstream::out);
    xr.open("testXOR_ALL_random.txt", fstream::out);
    r.open("testOR_ALL_random.txt", fstream::out);
    xnr.open("testXNOR_ALL_random.txt", fstream::out);
    nad.open("testNAND_ALL_random.txt", fstream::out);
    adyn.open("testANDYN_ALL_random.txt", fstream::out);
    adny.open("testANDNY_ALL_random.txt", fstream::out);
    rny.open("testORNY_ALL_random.txt", fstream::out);
    ryn.open("testORYN_ALL_random.txt", fstream::out);
    nr.open("testNOR_ALL_random.txt", fstream::out);
    enc.open("testENC_ALL_random.txt", fstream::out);
    ...
    for(int it = 0; it < nb_trials; it++) {
        ...
        for(int i = 1; i < nb_bits; i++) {
            bootsSymEncrypt(&temp[i], rand() % 2, key);
        }
