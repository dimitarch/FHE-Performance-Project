...
int main() {
    ...
    ad.open("testAND_ALL_pre.txt", fstream::out);
    xr.open("testXOR_ALL_pre.txt", fstream::out);
    r.open("testOR_ALL_pre.txt", fstream::out);
    xnr.open("testXNOR_ALL_pre.txt", fstream::out);
    nad.open("testNAND_ALL_pre.txt", fstream::out);
    adyn.open("testANDYN_ALL_pre.txt", fstream::out);
    adny.open("testANDNY_ALL_pre.txt", fstream::out);
    rny.open("testORNY_ALL_pre.txt", fstream::out);
    ryn.open("testORYN_ALL_pre.txt", fstream::out);
    nr.open("testNOR_ALL_pre.txt", fstream::out);
    enc.open("testENC_ALL_pre.txt", fstream::out);
